<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="java.util.*,com.nirman.contractor.*" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
<%
List<ContactorModel> m=(List<ContactorModel>)request.getAttribute("data");
HttpSession s1=request.getSession();
String name1=(String)s1.getAttribute("name");
...
box-shadow: 27px 32px 24px 17px rgba(0,0,0,0.75);
	...
	<%for(ContactorModel r:m){	%> 
       <div class="row">
         <div class="col-md-4">
           <div class="cdiv">
              <img src="<%=r.getPhoto() %>" width="50%" alt="jjjj">
           </div>
         </div>.
         ...
         <div class="col-md-3">
            <div class="adiv">
               <ul>
                 <li>name:<%=r.getName() %></li>
                 <li>email:<%=r.getEmail() %></li>
                 <li>phone:<%=r.getPhone() %></li>
                 <li>Qualification:<%=r.getQualification() %></li>
                 <li>city:<%=r.getCity() %></li>
               </ul>
            </div>
          </div>
         <div class="col-md-4">
            <div class="tdiv"> 
            <center>
              <p>Price to  hire is:Rs.100000/- </p>
              <a href="hireus.jsp"><button class="btn btn-primary">hire</button></a>
            </center>
            </div>
          </div>
       ...
       <%} %>
       <center>                       
                        <a href="contractorform.jsp"><button class="btn btn-primary">Join Us</button></a>
                    	</center>
